...
public class Main
{
    ...
    public static void section01()
    {
        ...
        System.out.println("4) Price of an adult meal at the buffet");
    ...
    public static void section02()
    {
        ...
        int population_US = 336799494;

        System.out.println("7) Current United States population");
        System.out.println("population_US: " + population_US);
        System.out.println();
        ...
        int population_CN = 1425146855;

        System.out.println("8) Current China population");
        System.out.println("population_CN: " + population_CN);
        System.out.println();
        ...
        long population_World = 8123651070L;

        System.out.println("9) Current world population");
        System.out.println("population_World: " + population_World);
        System.out.println();

        // 10. Declare a variable that specifies whether
        // or not your mouse is wireless.

        int isMouseWireless = 1;

        System.out.println("10) Is mouse wireless?");
        ...
        double homeTownLatitude = 35.415823;
        double homeTownLongitude = 136.721344;

        System.out.println("11) Latitude and longitude of my hometown");
        System.out.println("homeTownLatitude: " + homeTownLatitude);
        System.out.println("homeTownLongitude: " + homeTownLongitude);
        System.out.println();

        // 12. Create a variable that holds the current
        // Microsoft stock price.

        double stockPrice_Microsoft = 444.85;

        System.out.println("12) Current Microsoft stock price");
        System.out.println("stockPrice_Microsoft: " + stockPrice_Microsoft);
        System.out.println();
    ...
    public static void section03()
    {
        ...
        int shotsMade = 7;
        int shotsMissed = 3;
        int shotsTotal = shotsMade + shotsMissed;

        System.out.println("13) Number of shots Pete made");
        System.out.println("shotsTotal: " + shotsTotal);
        System.out.println();
        ...
        int threePtShotsMade = 3;
        shotsMissed = 6;
        shotsTotal = 20;
        int twoPtShotsMade = shotsTotal - threePtShotsMade - shotsMissed;

        System.out.println("14) Number of 2 point shots Pete made");
        System.out.println("twoPtShotsMade: " + twoPtShotsMade);
        System.out.println();
        ...
        int shotsPete = 6;
        int shotsPat = shotsPete * 2;
        shotsTotal = shotsPete + shotsPat;

        System.out.println("15) Number of total shots Pete and Pat made");
        System.out.println("shotsTotal: " + shotsTotal);
        System.out.println();
        ...
        System.out.println("16) Number of shots Terrifying Twosome made");
        System.out.println("shotsTotal: " + shotsTotal);
        System.out.println();
        ...
        shotsMade = 11;
        shotsMissed = 4;
        double percentageOfShots = (double)shotsMade / (shotsMade + shotsMissed) * 100;

        System.out.println("17) Percentage of shots Pete made");
        System.out.println("percentageOfShots: " + (int)percentageOfShots + "%");
        System.out.println();
        ...
        int pointsToWin = 33;
        double shotsToWin = (double)((33 / 3) * 10) / 7;

        System.out.println("18) Number of shots Pete and Pat have to take to win");
        System.out.println("shotsToWin: " + shotsToWin);
        System.out.println();
